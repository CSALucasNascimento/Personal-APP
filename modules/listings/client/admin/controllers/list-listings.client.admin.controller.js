(function () {
  ...
  angular
    ...
    .controller('ListingsAdminListController', ListingsAdminListController);

  ListingsAdminListController.$inject = ['$state', 'listingListResolve'];

  function ListingsAdminListController($state, listingListResolve) {
    var vm = this;
