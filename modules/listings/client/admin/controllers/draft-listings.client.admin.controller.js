(function () {
  ...
  angular
    ...
    .controller('ListingsAdminDraftController', ListingsAdminDraftController);

  ListingsAdminDraftController.$inject = ['$state', 'listingDraftResolve'];

  function ListingsAdminDraftController($state, listingDraftResolve) {
    var vm = this;

    vm.listings = listingDraftResolve;
