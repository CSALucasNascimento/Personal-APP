(function () {
  ...
  function msHorizontalStepperDirective() {
    return {
      ...
      transclude: true,
      templateUrl: 'modules/core/client/common/directives/ms-stepper/templates/horizontal/horizontal.html',
  ...
  function msVerticalStepperDirective($timeout) {
    return {
      ...
      transclude: true,
      templateUrl: 'modules/core/client/common/directives/ms-stepper/templates/vertical/vertical.html',
      compile: function (tElement) {
        tElement.addClass('ms-stepper');
