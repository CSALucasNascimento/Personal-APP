...
gulp.task('watch', function () {
  ...
  gulp.watch(defaultAssets.client.jsCommon, ['eslint']).on('change', plugins.refresh.changed);
  ...
  gulp.watch(defaultAssets.client.cssCommon, ['csslint']).on('change', plugins.refresh.changed);
  ...
  gulp.watch(defaultAssets.client.sassCommon, ['sass', 'csslint']).on('change', plugins.refresh.changed);
  ...
  gulp.watch(defaultAssets.client.lessCommon, ['less', 'csslint']).on('change', plugins.refresh.changed);
  ...
  if (process.env.NODE_ENV === 'production') {
    ...
    gulp.watch(defaultAssets.client.viewsCommon, ['templatecache']).on('change', plugins.refresh.changed);
...
gulp.task('csslint', function () {
  var assets = _.union(
    defaultAssets.client.cssCommon,
...
gulp.task('sass', function () {
  var assets = _.union(
    defaultAssets.client.sassCommon,
...
gulp.task('less', function () {
  var assets = _.union(
    defaultAssets.client.lessCommon,
...
gulp.task('imagemin', function () {
  var assets = _.union(
    defaultAssets.client.imgCommon,
...
gulp.task('karma:coverage', function(done) {
  new KarmaServer({
    configFile: __dirname + '/karma.conf.js',
    preprocessors: {
      'modules/*/client/common/views/**/*.html': ['ng-html2js'],
      'modules/*/client/admin/views/*.html': ['ng-html2js'],
      'modules/*/client/admin/views/**/*.html': ['ng-html2js'],
      'modules/*/client/site/views/**/*.html': ['ng-html2js'],
      'modules/core/client/app/config.js': ['coverage'],
      'modules/core/client/app/init.js': ['coverage'],
      'modules/*/client/*.js': ['coverage'],
      'modules/*/common/client/*.js': ['coverage'],
      'modules/*/admin/client/*.js': ['coverage'],
      'modules/*/site/client/*.js': ['coverage'],
      'modules/*/client/common/config/*.js': ['coverage'],
      'modules/*/client/admin/config/*.js': ['coverage'],
      'modules/*/client/site/config/*.js': ['coverage'],
      'modules/*/client/common/controllers/*.js': ['coverage'],
      'modules/*/client/admin/controllers/*.js': ['coverage'],
      'modules/*/client/admin/controllers/**/*.js': ['coverage'],
      'modules/*/client/site/controllers/*.js': ['coverage'],
      'modules/*/client/common/directives/*.js': ['coverage'],
      'modules/*/client/common/directives/**/*.js': ['coverage'],
      'modules/*/client/admin/directives/*.js': ['coverage'],
      'modules/*/client/site/directives/*.js': ['coverage'],
      'modules/*/client/common/services/*.js': ['coverage'],
      'modules/*/client/admin/services/*.js': ['coverage'],
      'modules/*/client/admin/services/**/*.js': ['coverage'],
      'modules/*/client/site/services/*.js': ['coverage'],
      'modules/*/client/site/services/**/*.js': ['coverage']
    },
