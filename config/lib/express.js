...
module.exports.initLocalVariables = function (app) {
  ...
  app.locals.jsFilesAdmin = config.files.client.jsAdmin;
  app.locals.jsFilesSite = config.files.client.jsSite;
  ...
  app.locals.cssFilesAdmin = config.files.client.cssAdmin;
  app.locals.cssFilesSite = config.files.client.cssSite;
...
module.exports.initModulesClientRoutes = function (app) {
  ...
  // Globbing static routing
  config.folders.client.siteApp.forEach(function (staticPath) {
    app.use(staticPath, express.static(path.resolve('./' + staticPath)));
  });
};
